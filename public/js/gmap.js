...
function GMap(id, info_id, data, zoom, templates, mapOpts) {
  ...
  //        { lightness: 100 },
    ...
    for (var i = 0; i < data.street_resurfacing.length; ++i) {
      ...
      var o = new GMapGeometry(map, sr[0], sr[1], {strokeColor: '#428bca'});
  ...
  this.renderMap = function(cost) {
    ...
    if (n_street_resurfacing){
      html += "<img src='/img/map_street_resurfacing.png' style='vertical-align: middle;' /> " +
    ...
    if (n_alley_resurfacing) {
      html += "<br><img src='/img/map_alley_resurfacing.png' style='vertical-align: middle;' /> " +
...
function drawMap(id, locations) {
  ...
  // Mark the locations given the lattitude and longitude
  var marker;
  // Reduce the zoom
